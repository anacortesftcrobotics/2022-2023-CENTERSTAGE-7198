...
import org.firstinspires.ftc.teamcode.logancode._7198CSPropProcessor;
...
public class _7198CSVisionManager {

    static final private int DEFAULT_ZONE_IF_VISION_FAILS = 3;
    VisionPortal visionPortal;
    _7198CSPropProcessor visProcessor;
    private AprilTagProcessor aprilTag;              // Used for managing the AprilTag detection process.
    private Scalar colorUpperBound;
    private Scalar colorLowerBound;

    public _7198CSVisionManager(_7198CSAuto.ALLIANCE thisAlliance, WebcamName thisWebcam)
    {
        ...
        visProcessor = new _7198CSPropProcessor(colorLowerBound, colorUpperBound);
