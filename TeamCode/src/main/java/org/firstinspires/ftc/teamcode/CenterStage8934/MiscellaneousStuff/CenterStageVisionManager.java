package org.firstinspires.ftc.teamcode.CenterStage8934.MiscellaneousStuff;
...
public class CenterStageVisionManager {
    ...
    public CenterStageVisionManager(CenterStageAutoBackstage.ALLIANCE thisAlliance, WebcamName thisWebcam)
    {
        if (thisAlliance == CenterStageAutoBackstage.ALLIANCE.RED)
        {
